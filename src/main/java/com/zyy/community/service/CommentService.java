...
import com.zyy.community.dao.CommentMapper;
...
public class CommentService implements CommunityConstant {
    ...
    public List<Comment> findCommentByEnitty(int entityType, int entityId, int offset, int limit){
    ...
    public int addComment(Comment comment){
       ...
       if(comment.getEntityType() == ENTITY_TYPE_POST){
           ...
           discussPostServicec.updateCommentCount(comment.getEntityId(), count);
       }
